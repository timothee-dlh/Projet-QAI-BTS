...
\end{titlepage}
    ...
    \includegraphics[width=440px]{Images/Localisations.png}
    \subsection{Secteur d'activité}
    \includegraphics[width=440px]{Images/Marques.png}
    \subsection{Produits phares}
    \includegraphics[width=440px]{Images/Secteur.png}
    \subsection{Chiffres clés}
    \includegraphics[width=440px]{Images/Chiffres.png}
    \newpage
    \subsection{Mes Missions}
    \begin{itemize}
        \item Sauvegarde du parc informatique des usines du site d'Obernai via la solution Veeam.
    ...
    \newline
    \includegraphics[width=440px]{Images/Cas_utilisation.png}
    \newpage
    ...
    \begin{tabular}{| C{5cm} | C{10cm} |}
        ...
        \hline
        MQTT & Récupération / Envoie des données du capteur \\
        \hline
        STM32H753ZI / ESP32-Wroom32E & Traitement des données du capteur et envoie au serveur \\
        \hline
        ...
        \hline
        Python3 / Rust & Script de récupération et d'envoie des données depuis MQTT vers MariaDB \\
        \hline
